...
export function ExerciseSelector({ open, onClose, onSelect }: ExerciseSelectorProps) {
  ...
  function startPress(img: string) {
    ...
    <>
                ...
                <div className="space-y-1">
                  {exs.map(ex => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="w-12 h-12 rounded-lg overflow-hidden bg-gray-800 flex-shrink-0 flex items-center justify-center select-none"
                          onPointerDown={() => img && startPress(img)}
      ...
      {previewImg && (
        <div
          ...
          onPointerUp={() => setPreviewImg(null)}
        >
          <button
            className="absolute top-4 right-4 p-2 rounded-full bg-gray-800 text-gray-300"
